...
//         any system.
        ...
        System.load("D:\\data_pre\\jars\\javamitie.dll"); //绝对路径
        System.load("D:\\data_pre\\jars\\msvcp100.dll"); //绝对路径
        System.load("D:\\data_pre\\jars\\msvcr100.dll"); //绝对路径
//        System.load("D:\\data_pre\\jars\\libjavamitie.so"); //绝对路径
//        System.loadLibrary("javamitie");
        


        System.out.println("loading NER model...");
        NamedEntityExtractor ner = new NamedEntityExtractor("D:\\data_pre\\src\\main\\resources\\MITIE-models\\english\\ner_model.dat");
        ...
        StringVector words = mitie.tokenize(mitie.loadEntireFile("D:\\data_pre\\src\\test\\resource\\sample_text.txt"));
